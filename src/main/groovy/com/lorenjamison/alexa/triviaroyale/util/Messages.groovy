...
class Messages {
    static final String NEW_PLAYER_WELCOME_MESSAGE = "Welcome to Trivia Royale! "

    static final String EXISTING_PLAYER_WELCOME_MESSAGE = "Welcome back to Trivia Royale! "

    static final String RULES_MESSAGE = "Test your brain power against other players in a battle royale style trivia game. " +
    ...
    static final String ASK_FOR_NAME_MESSAGE = "To get started, tell me your name."

    static final String ASK_TO_START_NEW_GAME_MESSAGE = "A new round of Trivia Royale is about to start. Would you like to play?"

    static final String INVALID_CATEGORY_SELECTION_MESSAGE = "Sorry, that's not a valid category. "

    static final String STARTING_NEW_GAME_MESSAGE = "Okay. Hold on while I find some opponents."
