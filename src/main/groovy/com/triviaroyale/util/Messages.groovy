...
class Messages {
    ...
    static final String RULES = "Test your brain power against other players in a battle royale style trivia game. " +
            "In each game, you will play against ${Constants.NUMBER_OF_PLAYERS - 1} other players. Each player" +
            "starts with $Constants.STARTING_HEALTH health points. I will ask you a series of " +
    ...
    static final String ASK_TO_START_NEW_GAME = 'A new round of Trivia Royale is about to start. ' +
